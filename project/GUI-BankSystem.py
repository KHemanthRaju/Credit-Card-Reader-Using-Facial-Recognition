...
def log_in(master):
	...
	label4 = tk.Label(loginwn , text="3.Press 's' to capture your face." , bg="#0019fc" , fg="white")
...
def Create():
	...
	label3.pack(side="top")
	label4 = tk.Label(crwn,text="3.Press 's' to capture your face." ,bg="#0019fc" , fg="white")
	label4.pack(side="top")
	label5 = tk.Label(crwn , text="4.Once the face is captured Press Submit button" , bg="#0019fc" , fg="white")
